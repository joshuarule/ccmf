    ...
    return (
      <>
        <div className="flex-1 flex--column">
          <header className={`container marginTop-4 bp-1_marginTop-12 bp-1_marginBottom-4`}>
            <div className={`${!isHome ? 'bp-1_flex flex-justify--spaceBetween border--bottom' : ''}`}>
              <h1 
              ...
              <div className={`bp-1_flex flex-justify--spaceBetween flex-align--end ${!isHome ? 'border--top' : ''}`}>
                ...
                <nav>
                  <ul className="list--clean bp-1_t-right">
                    ...
                    <li><a className="block link--clean paddingTop-2" href="https://goo.gl/maps/RLiLz5aHTGSXENav7" target="_blank" rel="noopener noreferrer">Spring & William  Catskill, NY</a></li>
                  </ul>
                </nav>
              </div>
            </div>
